...
from modules.game.game import _event_flags, _event_vars, encode_string
from modules.items.items import Item, ItemSlot, get_item_bag, _items_by_index, ItemPocket, get_item_by_name
from modules.map.map import get_encounter_affecting_abilities
