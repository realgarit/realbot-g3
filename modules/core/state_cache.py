...
if TYPE_CHECKING:
    ...
    from modules.items.items import ItemBag, ItemStorage
    from modules.map.map import EffectiveWildEncounterList
    from modules.game.memory import GameState
    from modules.player.player import Player, PlayerAvatar
    from modules.pokemon.pokemon_party import Party
    from modules.pokemon.pokemon_storage import PokemonStorage
    from modules.pokemon.pokedex import Pokedex
    from modules.core.tasks import TaskList, ScriptContext
